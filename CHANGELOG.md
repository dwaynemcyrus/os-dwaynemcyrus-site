...
- Prevented writing-editor save loops so frontmatter edits stop getting stuck in a repeated `Saving...` state and establish a correct local saved snapshot after save.
